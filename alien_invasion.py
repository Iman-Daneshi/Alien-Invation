...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        self.play_button = Button(self,'Play')
        Easy_button = Button(self,"Easy")
        Normal_button = Button(self,"Normal")
        Hard_button = Button(self,"Hard")
        self.buttons = [Easy_button, Normal_button, Hard_button]
    ...
    def run_game(self):    # controls the game
        ...
        while True:        
            ...
            self._check_events()
            if self.stats.game_active and self.stats.play:
                self.ship.update()
    ...
    def _check_bullet_alien_collisions(self):
        ...
        if collisions:
            for alien in collisions.keys():
                ...
                self.settings.shooted_aliens_list.append(alien)
                if self.settings.shooted_aliens_list.count(alien) == self.settings.alien_kills:
    ...
    def _check_level_button(self, mouse_pos):
        '''start the game with chosen dificulty level'''
        for button in self.buttons:
            button_clicked = button.rect.collidepoint(mouse_pos)
            if button_clicked and not self.stats.game_active:
                # Reset the game settings.
                self.settings.initialize_dynamic_settings(button.msg)
